...
static void arm_sched_fusion_priority (rtx, int, int *, int*);

...
static bool
fusion_load_store (rtx insn, rtx *base, rtx *offset, bool *is_load)
{
  rtx x, dest, src;
...
static void
arm_sched_fusion_priority (rtx insn, int max_pri,
