%define pkgname cross-armv7l-gcc49
%define cross_arch armv7l
%define gcc_target_arch armv7l-tizen-linux-gnueabi
...
mkdir obj-%{GCCDIST}
cd obj-%{GCCDIST}
RPM_OPT_FLAGS="$RPM_OPT_FLAGS -D_FORTIFY_SOURCE=1"
