...
# Force libdir for i586-for-aarch64 cross toolchain so that gcc include search
# path will be correct. The reason we need this is that the header files
# will be taken from native gcc in the build environment.
