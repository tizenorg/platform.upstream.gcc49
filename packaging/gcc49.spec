...
Conflicts: %selfconflict libgnarl-4_9
Provides: libgnat-4_9 = %{version}-%{release}
Conflicts: %selfconflict libgnat-4_9
...
Conflicts: %selfconflict libgnarl-4_9-32bit
Provides: libgnat-4_9-32bit = %{version}-%{release}
Conflicts: %selfconflict libgnat-4_9-32bit
...
Conflicts: %selfconflict libgnarl-4_9-64bit
Provides: libgnat-4_9-64bit = %{version}-%{release}
Conflicts: %selfconflict libgnat-4_9-64bit
